...
// content. С этапа 2 аудита (03.08.2026) канон — generate-fixtures.mjs: TS-движок
// по текущим src/content/tests (reference-scoring.mjs остался историческим
// эталоном оригинала tests_app и истиной больше не является).
