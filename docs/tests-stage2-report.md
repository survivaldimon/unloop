...
## Приложение: тексты пяти новых профилей (ru; en зеркалит, полные версии — в fixes/*.json profilesAdd)

### emotional_intelligence — подпрофили средней полосы

#### «Понимаешь на слух» / "Good Ear" (profile_developing_listener)

*Общий уровень у тебя средний, но профиль не ровный: сильнее всего — способность замечать и понимать чувства. Ты раньше других видишь, что человек расстроен, и обычно верно угадываешь почему. Слабое место — что с этим делать: понимание есть, а управление и разговор отстают.*

**Почему этот профиль:** Алгоритм считает средний уровень по семи шкалам теста. У тебя он в средней полосе (от 41 до 52 из 100) при заметном разбросе между шкалами, и на вершине — восприятие или понимание эмоций. Поэтому вместо общего «средне» тест называет твою сильную сторону.

**Сильные стороны:** Замечаешь сдвиги настроения раньше, чем их называют · Отличаешь усталость от обиды и злость от страха · Люди чувствуют, что их видят, — рядом с тобой не надо притворяться · Хорошо читаешь подтекст разговора

**Уязвимости:** Видеть чувство и справиться с ним — разные навыки: свои эмоции всё ещё накрывают · Понимание чужого состояния не всегда превращается в нужные слова · Чужие эмоции легко утаскивают за собой — граница между «замечаю» и «заражаюсь» тонкая

**Рекомендации:** Доводи замеченное до действия: увидел чувство — назови его вслух или спроси о нём · Тренируй выход, а не вход: что я сделаю с тем, что понял? · Когда накрывает своё — используй тот же навык на себе: назови чувство так же точно, как называешь чужие · Разбирай задним числом не людей, а свои реакции на них

**Попробуй сегодня:** Сегодня, когда заметишь чьё-то чувство, сделай следующий шаг: скажи об этом или спроси. Не оставляй наблюдение внутри.

**Финал:** Слух у тебя уже есть — остаётся поставить голос. Это быстрее, чем учить язык с нуля.

#### «Поставленный голос» / "Steady Voice" (profile_developing_voice)

*Общий уровень средний, но опора заметная: ты умеешь держать себя и направлять. Под нагрузкой не разваливаешься, начатое доводишь, эмоции редко управляют твоими решениями. Слабее другое — тонкое чтение: оттенки чувств, своих и чужих, проходят мимо, пока ты сосредоточен на деле.*

**Почему этот профиль:** Алгоритм считает средний уровень по семи шкалам теста. У тебя он в средней полосе (от 41 до 52 из 100) при заметном разбросе, и на вершине — управление собой, использование эмоций или мотивация. Тест называет сильную сторону, а не общее «средне».

**Сильные стороны:** Держишь себя в руках там, где других уносит · Умеешь превратить раздражение в топливо для дела · На тебя можно опереться в кризис — паника не твой жанр · Не бросаешь начатое из-за настроения

**Уязвимости:** «Держать себя» иногда означает «не слышать себя»: накопленное прорывается внезапно · Тихие сигналы других людей теряются за задачей · Спокойный тон читается как равнодушие, даже когда внутри не так

**Рекомендации:** Раз в день проверяй, что именно ты сейчас «держишь»: назови чувство, которое контролируешь · В разговорах спрашивай о чувствах прямо — вопросы работают не хуже интуиции · Планируй не только дела, но и разрядку: контроль без выпуска копит счёт · Скажи близким, что спокойствие — не безразличие; им это не очевидно

**Попробуй сегодня:** Три раза за день остановись и спроси: что я сейчас чувствую — не делаю, а чувствую? Назови одним точным словом.

**Финал:** Голос уже поставлен — осталось выучить слова. Слышать себя и других учатся, и с твоей дисциплиной это вопрос практики, а не таланта.

#### «Живой диалог» / "Fluent in Company" (profile_developing_dialogue)

*Общий уровень средний, но с людьми у тебя получается лучше всего: ты чувствуешь собеседника, попадаешь в тон, умеешь разрядить и поддержать. Слабее — наедине с собой: свои чувства ты разбираешь хуже, чем чужие, и под нагрузкой это заметно.*

**Почему этот профиль:** Алгоритм считает средний уровень по семи шкалам теста. У тебя он в средней полосе (от 41 до 52 из 100) при заметном разбросе, и на вершине — эмпатия или социальные навыки. Тест называет сильную сторону, а не общее «средне».

**Сильные стороны:** Настраиваешься на собеседника быстро и без усилия · Умеешь сказать трудное так, что тебя слышат · В компании от тебя теплеет — это навык, а не случайность · Конфликты рядом с тобой чаще гаснут, чем разгораются

**Уязвимости:** Чужое считываешь легко, своё — со скрипом: вопрос «а ты-то как?» ставит в тупик · Наедине с собой сложнее, чем на людях, — тишина выматывает · Настроившись на всех, забываешь, где твоя собственная волна

**Рекомендации:** Практикуй пять минут тишины с вопросом «что я чувствую?» — без телефона и собеседников · Переводи навык внутрь: опиши своё состояние так, как описал бы чужое · Проверяй, чьё чувство несёшь: твоё или подхваченное в разговоре · Разреши себе не быть поддержкой, когда сам на нуле, — и скажи об этом словами

**Попробуй сегодня:** Вечером опиши свой день так, как описал бы день друга: что человек чувствовал, где устал, что его задело. Про себя — в третьем лице.

**Финал:** С людьми ты уже говоришь свободно — остался один собеседник. Научись слушать себя так же, как слушаешь других, и язык станет родным.

### love_languages — новые комбо

#### «Сделал и принёс» / "Done and Delivered" (profile_service_gifts)

*Слова тебя не убеждают — убеждают поступки, которые можно увидеть и потрогать: починил, привёз, выбрал, принёс. Забота для тебя материальна, и это делает её проверяемой.*

**Почему этот профиль:** Забота делом и знаки внимания вышли вровень и выше остальных. Оба канала про одно: любовь должна оставлять след в физическом мире — вещь, результат, решённую проблему.

**Сильные стороны:** Ты замечаешь вложенный труд там, где другие видят «просто вещь» · Сам заботишься так, что это можно потрогать: делом, помощью, находкой · Тебя трудно купить словами — это защита от пустых обещаний

**Уязвимости:** Красивые слова без дел звучат для тебя как шум — но у многих людей слова и есть искренность · Когда помощи и знаков нет, ты делаешь вывод «не любит» раньше, чем стоит

**Рекомендации:** Скажи прямо: до меня доходит сделанное и принесённое, а не сказанное. Это сузит поиск для тех, кто рядом · Учись засчитывать и нематериальное: у некоторых людей «я слушал тебя час» — это их «починил кран»

**Попробуй сегодня:** Сделай для своего человека одну маленькую вещь руками — и вручи её. Посмотри, как твой родной канал работает в исходящую сторону.

**Финал:** Твоя любовь оставляет следы, которые можно потрогать. Люди с такими следами не сомневаются, что их любят.

#### «Из рук в руки» / "Hand to Hand" (profile_touch_gifts)

*Любовь для тебя проходит через руки: обнять, взять за плечо, вручить выбранную для тебя вещь. Дистанционные форматы — слова, звонки, «думаю о тебе» — доходят слабее, чем одно касание или один свёрток.*

**Почему этот профиль:** Прикосновения и знаки внимания вышли вровень и выше остальных. Общий знаменатель — физическое присутствие любви: её можно почувствовать кожей или удержать в руках.

**Сильные стороны:** Ты делаешь привязанность ощутимой — рядом с тобой она не абстракция · Помнишь, что кому приятно: и какое объятие, и какая мелочь обрадует · Твои подарки тёплые в буквальном смысле: выбраны про человека, а не для галочки

**Уязвимости:** Разлука и переписка — твои худшие форматы: этот канал связи просто не твой · Отстранённость партнёра бьёт вдвойне: нет ни касания, ни знака — и тебе уже «всё ясно» · Люди с дистантным стилем могут читать твою тактильность как напор

**Рекомендации:** В разлуке договорись о материальных якорях: вещь, которая остаётся с тобой, работает лучше десяти звонков · Спрашивай про касания прямо — у людей разная тактильная норма, и это не про любовь · Не меряй чувства других своей линейкой: у кого-то «держать за руку» — это слушать не перебивая

**Попробуй сегодня:** Обними своего человека дольше обычного — и оставь ему какую-нибудь мелочь «просто так». Два твоих языка за один вечер.

**Финал:** Ты передаёшь любовь из рук в руки — буквально. Это редкий и очень честный способ: его невозможно подделать на словах.
