...
export const ACCOUNT_COPY: Record<Lang, AccountCopy> = {
  en: {
    ...
    kinds: {
      ...
      grant_referral: "Friend invited",
      spend_report: "Quiz read",
      spend_photo: "Photo read",
      spend_test_report: "Test read",
      spend_portrait: "Cross-test portrait",
      spend_question: "Follow-up question",
      spend_insight: "Insight of the day",
      included_report: "Quiz read · Looplore+",
      included_photo: "Photo read · Looplore+",
      included_test_report: "Test read · Looplore+",
      included_portrait: "Portrait · Looplore+",
      included_question: "Question · Looplore+",
      included_insight: "Insight · Looplore+",
      refund: "Refund",
      adjust: "Adjustment",
    },
  ...
  ru: {
    ...
    kinds: {
      ...
      grant_referral: "За приглашение",
      spend_report: "Разбор по квизу",
      spend_photo: "Фото-разбор",
      spend_test_report: "Разбор теста",
      spend_portrait: "Сводный портрет",
      spend_question: "Вопрос в чате",
      spend_insight: "Инсайт дня",
      included_report: "Разбор по квизу · Looplore+",
      included_photo: "Фото-разбор · Looplore+",
      included_test_report: "Разбор теста · Looplore+",
      included_portrait: "Портрет · Looplore+",
      included_question: "Вопрос · Looplore+",
      included_insight: "Инсайт · Looplore+",
      refund: "Возврат",
