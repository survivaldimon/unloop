...
const LANG_SUFFIX: Record<string, string> = {
  ...
  ru: "\n\nВажно: обе главы напиши по-русски, на «ты», без канцелярита и калек с английского. Цитаты ответов пользователя уже на русском — вплетай их дословно. Название паттерна используй русское (поле nameRu).",
};
