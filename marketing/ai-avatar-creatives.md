# Looplore — Производство креативов с ИИ-аватарами (EN)
...
**Формат цели:** вертикальное видео 9:16, 1080×1920, 20–35 сек, «UGC talking head» — девушка 25–35 говорит в камеру как в сторис, перебивки b-roll, крупные субтитры, энд-кард с CTA `Find my loop →` и ссылкой looplore.app.
...
**Шаг 8. Экспорт и запуск.** 1080×1920, mp4, до 60 сек. Именование: `looplore_av_{script}_{hook}_{avatar}_v1`. Стартовая матрица: 2 аватара × 3 сценария × 2 хука = 12 креативов, дальше режь по CTR/CPM.
...
- [ ] Название файла по схеме `looplore_av_{script}_{hook}_{avatar}_v{n}`.
